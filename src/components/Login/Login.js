...
import loginImg from '../../images/lock.svg';
...
function Login() {
    ...
    return (
        <Container style={{marginTop: '100px'}} className='p-4 text-center'>
            <Row>
                <Col lg={4} md={6} sm={12} className="">
                    <form onSubmit={handleSubmit} className='p-3'>
                        ...
                        <input type='submit' className='btn btn-secondary form-control mt-2' value={newUser ? 'Create an account' : 'Login'} />
                        <br /><br />
                        <h6>
                            {newUser
                ...
                {newUser ? 'Login' : 'Create an account'}
                        ...
                        <hr />
                        <Button variant='secondary btn-block' onClick={handleGoogleSignIn}> <FontAwesomeIcon icon={faGoogle} /> Continue with Google </Button>
                    </form>
                </Col>
